...
AddEventHandler('chatMessage', function(source, name, msg, user_id)
  CancelEvent()
      ...
      for r=1, #cfgcmd do
        if sm[1] == cfgcmd[r].cmd then
          ...
          if vRP.hasPermission({user_id,cfgcmd[r].permission}) then
            ...
            --TriggerClientEvent('chatMessage', -1, cfgcmd[r].display.." " .. user_id .. " | " .. name.." ", { cfgcmd[r].r, cfgcmd[r].g, cfgcmd[r].b }, string.sub(msg,string.len(cfgcmd[r].cmd)+1))
            TriggerClientEvent('chatMessage', -1, cfgcmd[r].display.." ", { cfgcmd[r].r, cfgcmd[r].g, cfgcmd[r].b }, string.sub(msg,string.len(cfgcmd[r].cmd)+1))
          end
        end
      end
      ...
      if not iscmd and msg ~= nil then
        ...
        for v=1, #cfgrules do
          if vRP.hasPermission({user_id,cfgrules[v].permission}) then
            ...
            ing = true
            TriggerClientEvent('chatMessage', -1, cfgrules[v].display.." " .. user_id .. " | " .. name.." ", { cfgrules[v].r, cfgrules[v].g, cfgrules[v].b }, msg)
        ...
        if not ing then
          ...
          TriggerClientEvent('chatMessage', -1, cfgu.display.." " .. user_id .. " | " .. name .." ", { cfgu.r, cfgu.g, cfgu.b }, msg)
        end
      end
    end})
  end
