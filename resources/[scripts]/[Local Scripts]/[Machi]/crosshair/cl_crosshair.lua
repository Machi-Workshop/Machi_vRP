...
local function SaveDatas()
	...
	notify("~b~[크로스헤어]~g~ 크로스헤어 시스템이 저장되었습니다", 5000)
end
...
local function ResetDatas()
	...
	notify("~b~[크로스헤어]~g~ 크로스헤어 시스템이 초기화되었습니다", 5000)
...
-- Events
RegisterNetEvent("cookcrosshair:active")
...
RegisterNetEvent("cookcrosshair:edit")
AddEventHandler("cookcrosshair:edit", function()
	isEditing = true
end)

RegisterNetEvent("cookcrosshair:reset")
