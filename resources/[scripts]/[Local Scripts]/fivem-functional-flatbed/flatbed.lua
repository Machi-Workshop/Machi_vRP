...
AddTextEntry(controllerMessageLoweredCar, "~INPUT_CONTEXT~ 를 누르면 ~y~배드 ~w~ 가 올라갑니다.~n~ ~INPUT_DETONATE~ 누르면 ~r~차량 ~w~이 고정풀립니다.")
AddTextEntry(controllerMessageLoweredNoCar, "~INPUT_CONTEXT~ 를 누르면 ~y~배드 ~w~가 올라갑니다.~n~ ~INPUT_DETONATE~ 를 누르면 ~g~ 차량 ~w~ 고정이됩니다.")
AddTextEntry(controllerMessageRaised, " ~INPUT_CONTEXT~ 를 누르면 ~y~ 배드 ~w~가 내려갑니다.")
