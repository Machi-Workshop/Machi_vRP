...
local locations = {
    ...
    {439.40621948242,-990.33288574219,30.689603805542}, 
    {628.84228515625,-5.9961996078491,90.329010009766},
    ...
    {-338.32348632813,-681.73187255859,32.718215942383},
    {-334.62243652344,-681.86700439453,32.796192169189},
    {-331.18072509766,-681.83251953125,32.871353149414},
    {-280.37301635742,6227.017578125,31.705526351929},
	{63.185001373291,7226.1650390625,3.2974207401276}
	...
	while true do
		...
		for i,v in pairs(locations) do
			if Vdist(v[1],v[2],v[3],playerPos.x,playerPos.y,playerPos.z) < 3 then
				DrawMissionText2("~y~ ~o~E~y~를 눌러 자신을 변경하십시오",10)
			...
			if Vdist(v[1],v[2],v[3],playerPos.x,playerPos.y,playerPos.z) <= 12.0 then
				...
				DrawMarker(41,v[1], v[2], v[3],0, 0, 0, 0, 0, 0, 1.001,1.001,1.001,rainbow.r, rainbow.g, rainbow.b,200,1,0,0,true)
			end
		end
	end
end)
