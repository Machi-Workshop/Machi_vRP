...
doorList = {
    ...
    [11] = { ["ishash"] = 0, ["objName"] = "v_  ilev_gtdoor", ["x"]= 464.18, ["y"]= -1004.31,["z"]= 24.9152,["locked"]= true,["txtX"]=464.100,["txtY"]=-1003.538,["txtZ"]=26.064},
        ...
        for i = 1, #doorList do
            ...
            if(playerDistance < 1.15) then
				...
				if doorList[i]["locked"] == true then
                    DrawText3d(doorList[i]["txtX"], doorList[i]["txtY"], doorList[i]["txtZ"], "~b~[E] ~r~문이 닫혀있습니다.")
                else
                    DrawText3d(doorList[i]["txtX"], doorList[i]["txtY"], doorList[i]["txtZ"], "~b~[E] ~g~문이 열려있습니다.")
                end
