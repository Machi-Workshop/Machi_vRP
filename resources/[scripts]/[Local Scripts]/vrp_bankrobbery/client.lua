...
local banks = {
	...
	["pacific"] = {
		...
		reward = 400000 + math.random(200000,500000),
...
Citizen.CreateThread(function()
	while true do
		...
		if robbing then
			...
			bank_drawTxt(0.66, 1.44, 1.0,1.0,0.4, "은행 강도 : 보상까지 ~r~" .. secondsRemaining .. "~w~ 초 남았습니다!", 255, 255, 255, 255)
...
Citizen.CreateThread(function()
	while true do
		...
		if robbing then
			...
			bank_drawTxt(0.66, 1.44, 1.0,1.0,0.4, "은행 강도 : 성공까지 ~r~" .. secondsRemaining .. "~w~ 초 남았습니다!", 255, 255, 255, 255)
