...
window.onload = function () {
		...
		var eventCallback = {
			ui: function(data) {
				...
				if (config.showCredit == true) { document.querySelector('#credit').style.display = 'block'; }
				if (config.showRandombox == true) { document.querySelector('#randombox').style.display = 'block'; }
