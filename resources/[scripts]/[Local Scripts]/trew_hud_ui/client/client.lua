...
AddEventHandler('trew_hud_ui:setInfo', function(info)
	...
	SendNUIMessage({ action = 'setMoney', id = 'credit', value = info['credit'] })
	SendNUIMessage({ action = 'setMoney', id = 'randombox', value = info['randombox'] })
...
RegisterCommand('toggleui', function()
	if not toggleui then
		...
		SendNUIMessage({ action = 'element', task = 'disable', value = 'randombox' })
    ...
    if (Config.ui.showCredit == true) then
			SendNUIMessage({ action = 'element', task = 'enable', value = 'credit' })
		end
    if (Config.ui.showRandombox == true) then
			SendNUIMessage({ action = 'element', task = 'enable', value = 'randombox' })
		end
